...
const yoloWorker=new YoloWorker(()=>{console.log(`[${new Date().toLocaleString('en-US')}] [SnapshotSensors] Plugin loaded successfully — YOLO26 model loaded and ready for detection.`);});
